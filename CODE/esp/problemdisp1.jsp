...
rs2=st.executeQuery(sql2);
	...
	rs4=st.executeQuery(sql4);
              while(rs4.next())
	{
             	sql5="select * from Prob_history where Prob_about='"+ rs4.getString(2)+"' and status like 'unsolved'";
...
%>
								...
								<br><br><font color="yellow"><h3>UNSOLVED PROBLEMS OF <%=grp%></h3></font><IMG SRC="http://localhost:8081/esp/images/hr.gif" WIDTH="765" HEIGHT="2">
								...
								<th>Problem Priority</th>
									...
									<%	while(rs5.next())
											...
											<br>
<br>
<a href="http://localhost:8081/esp/problemdisp2.jsp"><b>View&nbsp;&nbsp;all&nbsp; solved problems&nbsp;</b></a>
<br><br><br><br>
<br><a 
