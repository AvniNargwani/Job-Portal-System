...
try
{
 ...
 String cit="insert into prob_history values('"+a+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"')" ;
...
<br><br><a href="http://localhost:8080/esp/problem.html"><b>Post Another Problem</b></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://localhost:8080/esp/custcontactprivi.html"><font  color="YELLOW"><b>YOUR PRIVILEGES</b></a></font>
<br><font color="yellow"><a href="http://localhost:8080/esp/index.html"><b>Homepage</b></font></a>
